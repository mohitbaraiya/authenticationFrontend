        ...
        <div className="px-4 py-8 bg-white shadow sm:rounded-lg sm:px-10">
          ...
          <div className="mt-6">
            ...
            <div className="grid grid-cols-3 gap-3 mt-6">
              ...
              <GoogleAuth className="inline-flex justify-center w-full px-4 py-2 text-sm font-medium text-gray-500 bg-white border border-gray-300 rounded-md shadow-sm google_button hover:bg-gray-50" />
            </div>
          </div>
        </div>
      </div>
